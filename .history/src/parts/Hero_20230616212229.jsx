            ...
            <div className="w-full inset-0 md:relative md:w-1/2">
              ...
              <div class="absolute w-full h-full">
                ...
                ></iframe>
                    ...
                    <img
                        // src={hero1}
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvh7p430WVQzfYVT1XzcdxDgC8BdJA3w2NSg&usqp=CAU"
                        alt="hero 1"
                        className="absolute inset-0 md:relative w-[250px] h-full object-cover object-center"
                    />
                </div>
            </div>
        </section>

                    ...
                    <div className="w-full mb-10">
                        ...
                        <div className="mt-4 flex items-center justify-center gap-2">
                            ...
                            <select
                                ...
                                className={`bg-red-500 text-white py-2 px-4 rounded ${isOptionDisabled ? 'opacity-50' : ''}`}
                            ...
                            {isOptionDisabled && <span className="text-red-500 ml-2">Pilih Jenjang Dulu!</span>}
                        </div>
                    </div>
                </div>
            </div>
